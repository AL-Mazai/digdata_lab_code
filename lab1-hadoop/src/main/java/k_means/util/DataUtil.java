...
public class DataUtil {
    //    public static final String HDFS_INPUT = "hdfs://43.138.121.194:9000/user/hadoop"; // input地址
//    public static final String HDFS_OUTPUT = "hdfs://43.138.121.194:9000/user/hadoop"; // output地址
    public static final String HDFS_INPUT = "/mapreduce/"; // input地址
    public static final String HDFS_OUTPUT = "/mapreduce/"; // output地址
    ...
    public static ArrayList<Double> splitStringIntoArray(String line) {
        ...
        System.out.println(Arrays.toString(lineContextArry));
    ...
    // 读入center
    public static void readCenterLines(LineReader lineReader, ArrayList<ArrayList<Double>> centers) throws IOException {
        Text line = new Text();
        // 每一行进行一次读取
