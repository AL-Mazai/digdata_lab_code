...
def get_current_weibo_data(elems, book_name_xls, name, yuedu, taolun, maxWeibo, num):
    ...
    while True:
        ...
        '''
        # 如果微博数量超过timeToSleep，则插入数据并休眠5秒（这段代码被注释掉了）
...
def spider(username, password, book_name_xls, sheet_name_xls, keyword, maxWeibo, num, save_pic):
    ...
    # print("超话链接获取完毕，休眠2秒")
    driver.get(
        "https://m.weibo.cn/p/index?extparam=%E6%AF%8F%E6%97%A5%E4%B8%80%E5%96%84%E9%98%B3%E5%85%89%E4%BF%A1%E7%94%A8&containerid=1008083bae004e4cb607f6fe81c428a0f924c2&luicode=10000011&lfid=100103type%3D1%26q%3D%E9%98%B3%E5%85%89")
    time.sleep(2)
    yuedu_taolun = driver.find_element(By.XPATH,
